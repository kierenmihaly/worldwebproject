...
public class JSONObjectMapperTestApp {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("1.Jsonvalue >> JSONObject사용 갑추출");
		...
		System.out.println("2.List<User> ==> json(String)변환 ");
		String jsonManyValue = objectMapper.writeValueAsString(list);
		System.out.println(jsonManyValue);
		
		System.out.println();
		
		System.out.println("2.JSON Value(String)==>List<User>변환및 갑ㅊ추출");
		List<User>returnList
			=objectMapper.readValue(jsonManyValue, 
		...
		System.out.println("2.JSON Value==>JSONObject 사용및 갑추출");
		...
		System.out.println("3.Map<User>==> JSON Value9String)로 변환");
		jsonManyValue = objectMapper.writeValueAsString(map);
		System.out.println(jsonManyValue);
		
		System.out.println();
		
		System.out.println("3.jsonvaluestirng >> map user로 변환");
			Map<String,User> returnMap
			= objectMapper.readValue(jsonManyValue, new 
		...
		System.out.println("2. json value==>jsonobject 사용,추출");
