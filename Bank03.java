public class Bank03 {
	...
	public void validate(String args[]){
		if(! (args.length == 2 || args.length == 4) {
			System.out.println("usage]::java Bank03 {customerName][option][money]");
		...
		if(args.length !=2 &&
			...
			System.out.println("[usage]::option을 확인하세요 :: 1 => 입금, 2 ==> 풀금");
			System.exit(0);
		}
	}
	...
	public void initialize(String[] value) {
		...
		bankName = value[1];
		if(value.length ==4) {
			command = Integer.parseIn(value[2]);
	...
	public void deposit(){
		balance +=money;
		System.out.pritnln(money+"원 입금함.");
	}
	
	public void withdwawal(){
		balance -= money;
